...
// new circles
function renderCirclesX(circlesGroup, newXScale,newYScale, chosenXaxis,chosenYaxis) {
...
function updateToolTip(chosenXAxis,chosenYAxis, circlesGroup) {
    ...
    else if  (chosenXAxis === "hair_length") {
        label = "Hair Length:";
    }
...
(async function(){
    var censusData = await d3.csv("hairData.csv");
